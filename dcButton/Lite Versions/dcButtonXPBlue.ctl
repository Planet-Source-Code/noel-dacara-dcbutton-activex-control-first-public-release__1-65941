VERSION 5.00
Begin VB.UserControl dcButtonXPBlue 
   AutoRedraw      =   -1  'True
   ClientHeight    =   495
   ClientLeft      =   0
   ClientTop       =   0
   ...
   ScaleMode       =   3  'Pixel
   ScaleWidth      =   100
   ToolboxBitmap   =   "dcButtonXPBlue.ctx":0000
End
Attribute VB_Name = "dcButtonXPBlue"
...
Public Enum eXPBlueButtonShapes
    elsCutNone  ' Normal
    elsCutLeft  '
    elsCutRight '
...
Private Enum eXPBlueButtonStates
...
Public Enum eXPBluePicAlignments
    elaBehindText
    elaBottomEdge
    elaBottomOfCaption
    elaLeftEdge
...
Public Enum eXPBluePictureSizes
...
Public Enum eXPBlueUserColors ' User-defined colors
    elcDownColor    ' ---
    elcFocusBorder  ' Available for use with the OverrideColor procedure
    elcGrayColor    ' For advance users only
    elcGrayText     ' Not accessible using VB IDE's properties window
    elcHoverColor   ' Note: Color property usage may vary between button styles
    elcStartColor   ' ---
End Enum

#If False Then
    ' Trick to preserve casing of these variables when used in VB IDE
    Private elcDownColor, elcFocusBorder, elcGrayColor
    Private elcGrayText, elcHoverColor, elcStartColor
#End If
...
Private Type tButtonProperties ' Cached button properties
    ...
    MaskColor   As Long
    PicAlign    As eXPBluePicAlignments
    PicDown     As StdPicture
    PicHot      As StdPicture
    PicNormal   As StdPicture
    PicOpacity  As Single
    PicSize     As eXPBluePictureSizes
    PicSizeH    As Long
    PicSizeW    As Long
    Shape       As eXPBlueButtonShapes
    UseMask     As Boolean
    Value       As Boolean
End Type
...
Private Type tButtonSettings        ' Runtime/designtime settings
    ...
    State       As eXPBlueButtonStates    ' Current drawing state of the button
...
Public Property Get ButtonShape() As eXPBlueButtonShapes
...
Public Property Let ButtonShape(Value As eXPBlueButtonShapes)
...
Public Property Get PictureAlignment() As eXPBluePicAlignments
...
Public Property Let PictureAlignment(Value As eXPBluePicAlignments)
...
Public Property Get PictureSize() As eXPBluePictureSizes
...
Public Property Let PictureSize(Value As eXPBluePictureSizes)
    If (m_tButtonProperty.PicNormal Is Nothing) Then
...
Public Sub OverrideColor( _
        Property As eXPBlueUserColors, _
...
Private Sub DrawButton(Optional State As eXPBlueButtonStates = -1, Optional Force As Boolean)
...
Private Sub DrawButtonXPStyle(DrawState As eXPBlueButtonStates)
